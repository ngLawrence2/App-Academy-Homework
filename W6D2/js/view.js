...
View.prototype.exercise3 = function () {
  ...
  //your code here!
    ...
    const $txt = $("<h1></h1>").text(i love jquery);
    $("#easel").append($txt);
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
   $(".square:nth-child(even)").text("Lawrence");
};
...
View.prototype.exercise6 = function () {
  ...
  $('square').each( function(index,element) {
    let $currSquare = $(element);
    $currSquare.css("background color", window._randomColorString());
  })
};
...
View.prototype.exercise7 = function(){
  ...
  $('square').each( function(index,element) {
    let $currSquare = $(element);
    console.log($currSquare.css("background-color"));
  })
};
