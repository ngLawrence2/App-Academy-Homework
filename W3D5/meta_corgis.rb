...
class MetaCorgiSnacks
  ...
  #     return  name.capitalize + ": " + @snack_box.send("get_#{name}_info", @box_id) + ' '+ "#{@snack_box.send("get_#{name}_tastiness",@box_id)}"
  #   else 
  #       raise 'no method'
  #   end 
  # end
  ...
  def self.define_snack(name)
    ...
    define_method(name) { name.capitalize + ": " + @snack_box.send("get_#{name}_info", @box_id) + ' '+ "#{@snack_box.send("get_#{name}_tastiness",@box_id)}"}
